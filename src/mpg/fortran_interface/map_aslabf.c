...
#ifdef FORTRANCAPS
#define mpg_cart_aslab_ PMPG_CART_ASLAB
#elif defined(FORTRANDOUBLEUNDERSCORE)
#define mpg_cart_aslab_ pmpg_cart_aslab__
#elif !defined(FORTRANUNDERSCORE)
#define mpg_cart_aslab_ pmpg_cart_aslab
#else
#define mpg_cart_aslab_ pmpg_cart_aslab_
#endif
#else
#ifdef FORTRANCAPS
#define mpg_cart_aslab_ MPG_CART_ASLAB
#elif defined(FORTRANDOUBLEUNDERSCORE)
#define mpg_cart_aslab_ mpg_cart_aslab__
#elif !defined(FORTRANUNDERSCORE)
#define mpg_cart_aslab_ mpg_cart_aslab
#endif
#endif

void mpg_cart_aslab_ ( file, comm_cart, ndims, slab_hi, slab_lo, length,

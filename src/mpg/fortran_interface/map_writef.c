...
#ifdef FORTRANCAPS
#define mpg_cart_write_ PMPG_CART_WRITE
#elif defined(FORTRANDOUBLEUNDERSCORE)
#define mpg_cart_write_ pmpg_cart_write__
#elif !defined(FORTRANUNDERSCORE)
#define mpg_cart_write_ pmpg_cart_write
#else
#define mpg_cart_write_ pmpg_cart_write_
#endif
#else
#ifdef FORTRANCAPS
#define mpg_cart_write_ MPG_CART_WRITE
#elif defined(FORTRANDOUBLEUNDERSCORE)
#define mpg_cart_write_ mpg_cart_write__
#elif !defined(FORTRANUNDERSCORE)
#define mpg_cart_write_ mpg_cart_write
#endif
#endif

 void mpg_cart_write_ ( file, comm_cart, ndims, length, pad, datatype,
                      buffer, ierr )
const char       *file;
MPI_Comm          comm_cart;
int              *ndims;

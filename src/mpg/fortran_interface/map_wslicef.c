...
#ifdef FORTRANCAPS
#define mpg_cart_wslice_ PMPG_CART_WSLICE
#elif defined(FORTRANDOUBLEUNDERSCORE)
#define mpg_cart_wslice_ pmpg_cart_wslice__
#elif !defined(FORTRANUNDERSCORE)
#define mpg_cart_wslice_ pmpg_cart_wslice
#else
#define mpg_cart_wslice_ pmpg_cart_wslice_
#endif
#else
#ifdef FORTRANCAPS
#define mpg_cart_wslice_ MPG_CART_WSLICE
#elif defined(FORTRANDOUBLEUNDERSCORE)
#define mpg_cart_wslice_ mpg_cart_wslice__
#elif !defined(FORTRANUNDERSCORE)
#define mpg_cart_wslice_ mpg_cart_wslice
#endif
#endif

 void mpg_cart_wslice_ ( file, comm_cart, ndims, slice, length, pad, datatype,
                      buffer, ierr )
const char       *file;
MPI_Comm          comm_cart;
int              *ndims;
